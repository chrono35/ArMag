...
setwd("/Users/dufresne/Documents/R_Project/ArMag")
devtools::document()
...
par(pty="s", "xaxp")
#thel <- Thellier.computation(mes.sel, begin.step.value = 250, end.step.value = 700, #aim.coef = 1E-10*1E6/vol)
#arai.graph(thel)

```

# test code genere.AMD
Préparation de la liste des échantillons
```{r}
List_ech <- NULL
...
for (i in 101:162) {
  ...
  nomB <- paste0(i,"BB")
  nomC <- paste0(i,"BC")
  List_ech <-  c(List_ech, nomA, nomB, nomC)
  
}
List_ech
```
Création du fichier AMD
```{r}
#file_AM <- "~/Documents/AM/40306B.AMD"
#genere.AMD(file.AMD = file_AM, list.ech = List_ech, shape = "Cyl")
```
